...
export default function Sale() {
  ...
  const sampleSaleProducts: Product[] = [
    ...
    },
    {
      ...
      sale_price: 147,
      is_sale: true,
      image_url: '/images/blackleatherboots.jpg',
      rating: 4.7,
      review_count: 29,
      brand: 'STEP CLASSIC',
      category: 'women',
    ...
    },
    {
      ...
      sale_price: 105,
      is_sale: true,
      image_url: '/images/silkblouse.jpg',
      rating: 4.5,
      review_count: 33,
      brand: 'SILK ESSENCE',
      category: 'women',
    ...
    // Men's Sale Items
    {
      ...
      sale_price: 99,
      is_sale: true,
      image_url: '/images/merinovneck.jpg',
      rating: 4.6,
      review_count: 45,
      brand: 'WOOL & CO',
      category: 'men',
    ...
    },
    {
      ...
      sale_price: 53,
      is_sale: true,
      image_url: '/images/navychinopants.jpg',
      rating: 4.4,
      review_count: 52,
      brand: 'URBAN FIT',
      category: 'men',
    ...
    },
    {
      ...
      sale_price: 117,
      is_sale: true,
      image_url: '/images/quiltedbomber.jpg',
      rating: 4.7,
      review_count: 36,
      brand: 'BOMBER STYLE',
      category: 'men',
    ...
    },
    {
      ...
      sale_price: 171,
      is_sale: true,
      image_url: '/images/oxfordleathershoes.jpg',
      rating: 4.8,
      review_count: 27,
      brand: 'OXFORD CRAFT',
      category: 'men',
    ...
    // Accessories Sale Items
    {
      ...
      sale_price: 255,
      is_sale: true,
      image_url: '/images/italianleatherhandbag.jpg',
      rating: 4.9,
      review_count: 31,
      brand: 'MILANO BAGS',
    ...
    },
    {
      ...
      sale_price: 537,
      is_sale: true,
      image_url: '/images/swissautomaticwatch.jpg',
      rating: 4.8,
      review_count: 24,
      brand: 'SWISS TIME',
      category: 'accessories',
    ...
    },
    {
      ...
      sale_price: 135,
      is_sale: true,
      image_url: '/images/designersunglasses.jpg',
      rating: 4.5,
      review_count: 39,
      brand: 'SHADE STYLE',
      category: 'accessories',
    ...
    },
    {
      ...
      sale_price: 189,
      is_sale: true,
      image_url: '/images/pearlnecklace.jpg',
      rating: 4.6,
      review_count: 28,
      brand: 'PEARL LUXURY',
      category: 'accessories',
    ...
    },
    {
      ...
      sale_price: 87,
      is_sale: true,
      image_url: '/images/bohemiankimono.jpg',
      rating: 4.4,
      review_count: 34,
      brand: 'BOHO CHIC',
      category: 'women',
    ...
    },
    {
      ...
      sale_price: 75,
      is_sale: true,
      image_url: '/images/denimtruckerjacket.jpg',
      rating: 4.3,
      review_count: 47,
      brand: 'DENIM CLASSIC',
      category: 'men',
    ...
    },
    {
      ...
      sale_price: 45,
      is_sale: true,
      image_url: '/images/crossbodyphonebag.jpg',
      rating: 4.2,
      review_count: 56,
      brand: 'MINI BAGS',
      category: 'accessories',
    ...
    },
    {
      ...
      sale_price: 207,
      is_sale: true,
      image_url: '/images/woolblendpeacoat.jpg',
      rating: 4.7,
      review_count: 22,
      brand: 'NAVAL STYLE',
      category: 'men',
