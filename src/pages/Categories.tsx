...
const featuredProducts = [
  {
    ...
    isNew: false,
    isSale: true,
    image: "/images/textureddress.png"
  },
  {
  ...
  },
  {
    ...
    isNew: false,
    isSale: false,
    image: "/images/Crossbody Phone Bag.jpg"
  }
];
        ...
        <section className="relative py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Explore our complete collection of premium fashion across all categories. 
              From elegant dresses to sophisticated accessories, find everything you need 
                    ...
                    <CardContent className="p-0">
                      <div className="relative">
                        ...
                        <div className="absolute top-4 left-4">
                          <Badge className={`
                            ${category.id === 'sale' ? 'bg-red-500' : 'bg-luxury'} 
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {featuredProducts.map((product) => (
                <Card key={product.id} className="group card-fashion hover:shadow-xl transition-all duration-300 border-0">
                  <CardContent className="p-0">
                    ...
                    <div className="p-6 space-y-3">
                      ...
                      <div className="flex gap-2 pt-2">
                        ...
                        <Link to={`/${product.category.toLowerCase()}`} className="flex-1">
                          <Button variant="outline" className="w-full border-luxury text-luxury hover:bg-luxury hover:text-white" size="sm">
                            View Details
                          </Button>
                        </Link>
                      </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/men">
                <Button variant="outline" className="border-luxury text-luxury hover:bg-luxury hover:text-white">
